...
df_v = pd.read_json('bin_val.json')
...
for i in data:
    ...
    prompt = f"You are an experienced clinician specializing in Major Depressive Disorder (MDD). Please predict each participant\u2019s overall depression class based on the following dialogue out of the possible classes of 'Non depressed' and 'Depressed'.\n{dialogue}"
    messages = [
